...
const PurchasePipeline = React.lazy(() =>
  import("./views/pages/purchasePipeline")
);
...
const routes = [
  { path: "/", exact: true, name: "Home" },
  {
    ...
    name: "Dashboard",
    element: Dashboard,
    noPermissinRequired: true,
    canPermissions: ["dashboard", "read_products"],
  },
  ...
  {
    path: "/purchase-pipeline/:id",
    name: "Purchase Pipeline",
    element: PurchasePipeline,
    canPermissions: [
      "read_customers",
      "create_customers",
      "update_customers",
