            ...
            >
              ...
              >
                    ...
                    <CRow className="row g-3 px-3 mt-1 mb-5">
                      ...
                      <CCol md={6}>
                        <CFormInput
                          ...
                          id="inputPassword4"
                          label="Sort Order"
                          {...register("sort", categoryOptions.sort)}
                        />
                      </CCol>
                      <CCol md={6}>
                        <CFormSelect
                          ...
                          id="inputState"
                          label="Parent"
                          {...register("parent_id", categoryOptions.parent_id)}
                        >
                      ...
                      <CCol md={6}>
                        <CFormSelect
                          ...
                          id="inputState"
                          label="Status"
                          {...register("status", categoryOptions.status)}
                        >
                ...
                <CModalFooter className="mt-4">
                  <input
                    type="hidden"
                    {...register("_id", categoryOptions._id)}
                  ></input>
