...
const SalesPipeline = () => {
  ...
  const [invoiceFormVisible, setInvVisible] = useState(false);
  ...
  const createInvoice = (data) => {
    ...
    /**Fetch Data from S.O Obj */
    data.customer_id = order.customer_id;
    data.items = order.items;
    data.order_no = order.order_no;
    data.sale_details = order.sale_details;
    data.sales_executives = order.sales_executives;
  ...
  const getShipmentData = (data) => {
    axios
      .get(process.env.REACT_APP_API_URL + "/shipment", {
        params: { sales_order: id },
        headers: { Authorization: localStorage.getItem("token") ?? null },
      })
      .then((response) => {
  ...
  const onInvoiceErrors = (errors) => {
    console.log("==== inv errors", errors);
    validationAlertPop(errors);
  };
  ...
  useEffect(() => {
    if (shipmentData != null) {
      shipmentData.shipment_date = DateTime.fromISO(
  ...
  const getOrder = async (id, index) => {
    return await axios
      ...
      .then((res) => {
        if (res.data.status === 404) return navigate("/404");
          ...
          <CCardBody>
            <CTabContent className="mt-4">
                  ...
                  <CCol xs={12}>
                    <CRow className="row g-3 px-3 mt-1 mb-5">
                      ...
                      <CCol md={6}>
                        <CFormSelect
                          id="inputState"
                          floatingLabel="Customer"
                          disabled
                          {...register("customer_id", options.customer_id)}
                        >
                          <option value="">...</option>
                      ...
                      <CCol md={6}>
                        <CFormSelect
                          ...
                          multiple
                          disabled
                          floatingLabel="Sales Executive"
                          {...register(
                            "sales_executives[]",
                            options.sales_executive
                          )}
                        >
                          <option value="">...</option>
              ...
              >
                ...
                {packageData ? (
                  ...
                  <CForm
                    onSubmit={handleSubmit(onPackageSubmit, onPackageErrors)}
                  >
                    <CCol xs={12}>
                      {/* Show Package Form  */}
                      <CRow className="row g-3 px-3 mt-1 mb-5">
                        ...
                        <CCol md={6}>
                          <CFormInput
                            type="text"
                            id="inputEmail4"
                            floatingLabel="Package Slip#"
                            {...register("package_slip", options.order_no)}
                          />
                          {errors.order_no && (
                            <div className="invalid-validation-css">
                              This field is required
                        ...
                        <CCol md={12}>
                          <CFormTextarea
                            id="cost_data"
                            floatingLabel="Package Notes"
                            style={{ height: "100px" }}
                            {...register("package_notes")}
                            rows="6"
                          ></CFormTextarea>
                        </CCol>
              ...
              >
                <CForm
                  onSubmit={handleSubmit(onShippingSubmit, onShippingErrors)}
                >
                  <CCol xs={12}>
                    <CRow className="row g-3 px-3 mt-1 mb-5">
                      <ValidationAlert
                      ...
                      <CCol md={6}>
                        <CFormSelect
                          ...
                          {...register("shipment.shipping_type")}
                        >
                          <option value="">...</option>
                      ...
                      <CCol md={6}>
                        <CFormInput
                          ...
                          id="inputPassword4"
                          floatingLabel="Shipment Date"
                          {...register("shipment.shipment_date")}
                        />
                      </CCol>
                      <CCol md={6}>
                        <CFormSelect
                      ...
                      <CCol md={12}>
                        <CFormTextarea
                          ...
                          floatingLabel="Shipping Notes"
                          style={{ height: "100px" }}
                          {...register("shipment.shipping_notes")}
                          rows="6"
                        ></CFormTextarea>
                      </CCol>
                            ...
                            <div className="card-body p-4">
                              <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex flex-column">
                                  ...
                                  <span className="text-muted small">
                                    {DateTime.fromISO(order.sale_date).toFormat(
                                      "dd LLL , yyyy"
                                    )}
                                  </span>
                                </div>
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="d-flex flex-column">
                                  <span className="fw-normal">
                                    Balace:{" "}
                                    <strong>
                                      ${invoiceData.sale_details.total}
                                    </strong>
                                  </span>
                                  <span className="text-muted small">
                                    Due on{" "}
                          ...
                          <div id="invoice">
                            <div className="toolbar hidden-print">
                              <div className="text-end">
                                ...
                                >
                                  <i className="fa fa-file-pdf-o"></i> Export as
                                  PDF
                                </button>
                              </div>
                              <hr />
                                ...
                                <main>
                                  <div className="row contacts">
                                    <div className="col invoice-to">
                                      ...
                                      <h2 className="to">
                                        {invoiceData.customer_id?.name}
                                      </h2>
                                      <div className="email">
                                        <a href="mailto:john@example.com">
                                          {invoiceData.customer_id.email}
                                        </a>
                                        <div className="address">
                                          {
                                            invoiceData.customer_id?.address
                                              .address_line1
                                          }{" "}
                                          {
                                            invoiceData.customer_id?.address
                                  ...
                                  <table>
                                    ...
                                    <tfoot>
                                      <tr>
                                        ...
                                        <td>
                                          ${invoiceData.sale_details?.sub_total}
                                        </td>
                                      </tr>
                                      <tr>
                                        <td colSpan="2"></td>
            ...
            {invoiceData ? (
              ...
              >
                <CModalHeader>
                  <CModalTitle>
                    Payment for ({invoiceData?.invoice_no})
                  </CModalTitle>
                </CModalHeader>
                <CForm
                  onSubmit={handleSubmit2(onPaymentSubmit, onPaymentErrors)}
                >
                  <CCol xs={12}>
                    <CRow className="row g-3 px-3 mx-2 py-5">
                      ...
                      <fieldset className="row mb-1">
                        ...
                        <CCol sm={10}>
                          <CFormCheck
                            ...
                            value="full_amount"
                            label="Full amount"
                            {...register2("payment.payment_type", {
                              required: true,
                            })}
                          />
                          <CFormCheck
                      ...
                      <CCol md={6}>
                        <CFormSelect
                          ...
                          {...register2("payment.payment_mode")}
                        >
                          <option value="">...</option>
                          <option>Cash</option>
                      ...
                      <CCol md={6}>
                        <CFormInput
                          ...
                          id="inputAmount"
                          readOnly
                          value={invoiceData?.sale_details.total}
                          floatingLabel="Amount"
                          {...register2("payment.amount")}
                        />
                        {errors.tracking_no && (
                          <div className="invalid-validation-css">
                            This field is required
                      ...
                      <CCol md={6}>
                        <CFormInput
                          ...
                          {...register2("payment.payment_date")}
                        />
                      </CCol>
                      <CCol md={6}>
                        <CFormSelect
            ...
            >
              ...
              <CForm onSubmit={handleSubmit3(onInvoiceSubmit, onInvoiceErrors)}>
                <CCol xs={12}>
                  <CRow className="row g-3 px-3 mx-2 py-5">
                    <ValidationAlert
                      validate={{ visible: validationAlert, errorObjData }}
                    ...
                    <CCol md={6}>
                      <CFormInput
                        type="text"
                        id="inputEmail4"
                        floatingLabel="Invoice No#"
                        {...register3("invoice.invoice_no", { required: true })}
                      />
                      {errors3?.invoice?.invoice_no && (
                        <div className="invalid-validation-css">
                    ...
                    <CCol md={6}>
                      <CFormInput
                        type="text"
                        id="inputEmail4"
                        floatingLabel="S.O No#"
                        disabled
                        value={order.order_no}
                        {...register3("invoice.order_no")}
                      />
                      {errors3?.invoice?.order_no && (
                        <div className="invalid-validation-css"></div>
                      )}
                    </CCol>
                    ...
                    <CCol md={6}>
                      <CFormInput
                        type="date"
                        id="inputPassword4"
                        floatingLabel="Invoice Date"
                        {...register3("invoice.invoice_date", {
                          required: true,
                        })}
                      />
                      {errors3?.invoice?.invoice_date && (
                        <div className="invalid-validation-css">
                    ...
                    <CCol md={6}>
                      <CFormInput
                        ...
                        {...register3("invoice.due_date", { required: true })}
                      />
                      {errors3?.invoice?.due_date && (
                        <div className="invalid-validation-css">
                    ...
                    <CCol md={6}>
                      <CFormSelect
                        ...
                        {...register3("invoice.status", { required: true })}
                      >
                        <option value="">...</option>
                        <option>Completed</option>
