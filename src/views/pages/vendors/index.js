...
const Vendor = () => {
  ...
  const [contactPersonsT, setContacts] = useState([
    { saluation: "", fname: "", lname: "", email: "", phone: "" },
  ]);
  ...
  const deleteAction = (data) => {
    axios
      .delete(process.env.REACT_APP_API_URL + "/vendors", {
        headers: { Authorization: localStorage.getItem("token") ?? null },
        data: { _id: [data._id] },
      })
      .then((response) => {
                        ...
                        <div className="row g-3 mt-4 px-3">
                          ...
                          <CCol md={6}>
                            <CFormSelect
                              ...
                              id="inputState"
                              label="Saluation"
                              {...register("saluation", options.saluation)}
                            >
                              <option value="">Choose...</option>
                              <option>Mr.</option>
                              <option>Mrs.</option>
                          ...
                          <CCol md={3}>
                            <CFormInput
                              ...
                              id="inputFName4"
                              label="Fisrt Name"
                              {...register("first_name", options.first_name)}
                            />
                          </CCol>
                          <CCol md={3}>
                            <CFormInput
                              ...
                              id="inputLName"
                              label="Last Name"
                              {...register("last_name", options.last_name)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                        ...
                        <option>Individual</option>
                          ...
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="inputProfile"
                              label="Profile"
                              {...register("profile", options.profile)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              {...register("alt_phone", options.alt_phone)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              {...register("alt_email", options.alt_email)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="inputPhone4"
                              label="Whatsapp"
                              {...register("whatsapp", options.whatsapp)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="inputPhone4"
                              label="Instagram"
                              {...register("instagram", options.instagram)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="twitter"
                              label="Twitter"
                              {...register("twitter", options.twitter)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="facebok"
                              label="Facebok"
                              {...register("facebook", options.facebook)}
                            />
                          </CCol>
                          <CCol md={6}>
                            <CFormInput
                              ...
                              id="website_url"
                              label="Website"
                              {...register("facebook", options.website_url)}
                            />
                          </CCol>
                          <CCol md={12}>
                            <div className="me-md-2 mt-4 float-end ">
